...
LeitorProfessor::LeitorProfessor(int novoId,string novoNome, int novaIdade)
:Leitor(novoId,novoNome, novaIdade) {}

void LeitorProfessor::Show() {
    cout<<"ID= "<<getId()<<endl;
...
LeitorProfessor::~LeitorProfessor() {}
